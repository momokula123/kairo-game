...
(function (global) {
  ...
  const IMG_SRC = {
    ...
    great_wall: 'assets/great_wall.png?v=1',
    stonehenge: 'assets/stonehenge.png?v=1',
    taj_mahal: 'assets/taj_mahal.png?v=1',
    parthenon: 'assets/parthenon.png?v=1',
    machu_picchu: 'assets/machu_picchu.png?v=1',
    leaning_tower: 'assets/leaning_tower.png?v=1',
    angkor_wat: 'assets/angkor_wat.png?v=1',
    hanging_garden: 'assets/hanging_garden.png?v=1',
    terracotta_army: 'assets/terracotta_army.png?v=1',
    colossus_of_rhodes: 'assets/colossus_of_rhodes.png?v=1',
    ishtar_gate: 'assets/ishtar_gate.png?v=1',
    lighthouse_of_alexandria: 'assets/lighthouse_of_alexandria.png?v=1',
    great_buddha: 'assets/great_buddha.png?v=1',
    forbidden_city: 'assets/forbidden_city.png?v=1',
    temple_of_heaven: 'assets/temple_of_heaven.png?v=1',
    moai: 'assets/moai.png?v=1',
    airplane: 'assets/airplane.png?v=1',
    cannon: 'assets/cannon.png?v=1',
    kfc: 'assets/kfc.png?v=1',
    mcdonald: 'assets/mcdonald.png?v=1',
    mixue: 'assets/mixue.png?v=1',
    school: 'assets/school.png?v=1',
    kindergarten: 'assets/kindergarten.png?v=1',
    yangtze_bridge: 'assets/yangtze_bridge.png?v=1',
    burj_arab: 'assets/burj_arab.png?v=1',
    eiffel: 'assets/eiffel.png?v=1',
    sydney_opera: 'assets/sydney_opera.png?v=1',
    chinese_house_1: 'assets/chinese_house_1.png?v=1',
    chinese_house_2: 'assets/chinese_house_2.png?v=1',
    chinese_house_3: 'assets/chinese_house_3.png?v=1',
    chinese_house_4: 'assets/chinese_house_4.png?v=1',
    chinese_house_5: 'assets/chinese_house_5.png?v=1',
    snack_busy: 'assets/snack_busy.png?v=1',
  ...
  const ALIGN_KEYS = new Set([
    ...
    'pyramid', 'sphinx', 'peach_garden', 'chibi', 'pagoda', 'dojo', 'observatory', 'bathhouse', 'bank', 'stable', 'granary', 'temple', 'china_tower', 'guard_post', 'obelisk', 'dungeon', 'mage_tower', 'greenhouse', 'training_ground',
     'great_wall', 'stonehenge', 'taj_mahal', 'parthenon', 'machu_picchu', 'leaning_tower', 'angkor_wat', 'hanging_garden', 'terracotta_army', 'colossus_of_rhodes', 'ishtar_gate', 'lighthouse_of_alexandria', 'great_buddha', 'forbidden_city', 'temple_of_heaven', 'moai',
     'airplane', 'cannon', 'kfc', 'mcdonald', 'mixue', 'school', 'kindergarten', 'yangtze_bridge', 'burj_arab', 'eiffel', 'sydney_opera', 'chinese_house_1', 'chinese_house_2', 'chinese_house_3', 'chinese_house_4', 'chinese_house_5', 'snack_busy', 'library',
     'fence_a', 'fence_b',
  ...
  const MASK_KEYS = new Set(['inn', 'tavern', 'weapon', 'shop', 'bakery', 'magicshop', 'training', 'clinic', 'castle', 'farm', 'seedshop', 'forge', 'market', 'shrine', 'library', 'barracks', 'powerplant', 'refinery', 'windmill', 'church', 'tower', 'colosseum', 'empire', 'lighthouse', 'statue', 'pyramid', 'sphinx', 'peach_garden', 'chibi', 'pagoda', 'dojo', 'observatory', 'bathhouse', 'bank', 'stable', 'granary', 'temple', 'china_tower', 'guard_post', 'obelisk', 'dungeon', 'mage_tower', 'greenhouse', 'training_ground', 'great_wall', 'stonehenge', 'taj_mahal', 'parthenon', 'machu_picchu', 'leaning_tower', 'angkor_wat', 'hanging_garden', 'terracotta_army', 'colossus_of_rhodes', 'ishtar_gate', 'lighthouse_of_alexandria', 'great_buddha', 'forbidden_city', 'temple_of_heaven', 'moai', 'airplane', 'cannon', 'kfc', 'mcdonald', 'mixue', 'school', 'kindergarten', 'yangtze_bridge', 'burj_arab', 'eiffel', 'sydney_opera', 'chinese_house_1', 'chinese_house_2', 'chinese_house_3', 'chinese_house_4', 'chinese_house_5', 'snack_busy', 'library']);
    ...
    Shadow: {
      ...
      config: {
        ...
        shrinkX: {
          ...
          great_wall: 1, stonehenge: 1, taj_mahal: 1, parthenon: 1, machu_picchu: 1, leaning_tower: 1, angkor_wat: 1, hanging_garden: 1, terracotta_army: 1, colossus_of_rhodes: 1, ishtar_gate: 1, lighthouse_of_alexandria: 1, great_buddha: 1, forbidden_city: 1, temple_of_heaven: 1, moai: 1, airplane: 1, cannon: 1, kfc: 1, mcdonald: 1, mixue: 1, school: 1, kindergarten: 1, yangtze_bridge: 1, burj_arab: 1, eiffel: 1, sydney_opera: 1, chinese_house_1: 1, chinese_house_2: 1, chinese_house_3: 1, chinese_house_4: 1, chinese_house_5: 1, snack_busy: 1, library: 1,
