...
(function (global) {
  ...
  const BUILD_DEFS = {
    ...
    /* ===== 神迹景观 20 ===== */
    great_wall: { name: '长城', icon: '长', desc: '万里长城，村庄防御大增', baseCost: 2000, income: 60, maxLevel: 3, w: 140, h: 90, image: 'great_wall', size: 2, effect: 'great_wall' },
    stonehenge: { name: '巨石阵', icon: '石', desc: '神秘巨石环，声望提升', baseCost: 900, income: 30, maxLevel: 3, w: 110, h: 90, image: 'stonehenge', size: 2, effect: 'stonehenge' },
    taj_mahal: { name: '泰姬陵', icon: '泰', desc: '白色大理石陵墓，收入高', baseCost: 1800, income: 55, maxLevel: 3, w: 120, h: 100, image: 'taj_mahal', size: 2, effect: 'taj_mahal' },
    parthenon: { name: '帕特农神庙', icon: '帕', desc: '希腊神庙，智慧提升', baseCost: 1300, income: 42, maxLevel: 3, w: 110, h: 90, image: 'parthenon', size: 2, effect: 'parthenon' },
    machu_picchu: { name: '马丘比丘', icon: '马', desc: '印加空中之城，声望大增', baseCost: 1600, income: 50, maxLevel: 3, w: 120, h: 90, image: 'machu_picchu', size: 2, effect: 'machu_picchu' },
    leaning_tower: { name: '比萨斜塔', icon: '斜', desc: '倾斜的钟楼，地标收入', baseCost: 1000, income: 36, maxLevel: 3, w: 80, h: 130, image: 'leaning_tower', size: 2, effect: 'leaning_tower' },
    angkor_wat: { name: '吴哥窟', icon: '吴', desc: '高棉神庙，声望提升', baseCost: 1400, income: 46, maxLevel: 3, w: 120, h: 95, image: 'angkor_wat', size: 2, effect: 'angkor_wat' },
    hanging_garden: { name: '空中花园', icon: '空', desc: '巴比伦空中花园，收入稳定', baseCost: 1500, income: 48, maxLevel: 3, w: 110, h: 95, image: 'hanging_garden', size: 2, effect: 'hanging_garden' },
    terracotta_army: { name: '兵马俑', icon: '俑', desc: '地下军阵，防御大增', baseCost: 1200, income: 40, maxLevel: 3, w: 110, h: 85, image: 'terracotta_army', size: 2, effect: 'terracotta_army' },
    colossus_of_rhodes: { name: '太阳神巨像', icon: '阳', desc: '罗德岛青铜巨像，地标收入', baseCost: 1700, income: 52, maxLevel: 3, w: 90, h: 120, image: 'colossus_of_rhodes', size: 2, effect: 'colossus_of_rhodes' },
    ishtar_gate: { name: '伊什塔尔门', icon: '伊', desc: '巴比伦蓝釉城门，声望大增', baseCost: 1100, income: 38, maxLevel: 3, w: 100, h: 110, image: 'ishtar_gate', size: 2, effect: 'ishtar_gate' },
    lighthouse_of_alexandria: { name: '亚历山大灯塔', icon: '亚', desc: '古代世界奇观，声望提升', baseCost: 1300, income: 44, maxLevel: 3, w: 85, h: 120, image: 'lighthouse_of_alexandria', size: 2, effect: 'lighthouse_of_alexandria' },
    great_buddha: { name: '大佛', icon: '佛', desc: '金身大佛，净化心灵收高', baseCost: 1200, income: 42, maxLevel: 3, w: 85, h: 120, image: 'great_buddha', size: 2, effect: 'great_buddha' },
    forbidden_city: { name: '故宫', icon: '宫', desc: '皇家宫殿，声望收入双高', baseCost: 2500, income: 70, maxLevel: 3, w: 140, h: 95, image: 'forbidden_city', size: 2, effect: 'forbidden_city' },
    temple_of_heaven: { name: '天坛', icon: '天', desc: '祈年殿，祷告提升心情', baseCost: 1300, income: 44, maxLevel: 3, w: 100, h: 90, image: 'temple_of_heaven', size: 2, effect: 'temple_of_heaven' },
    moai: { name: '摩艾石像', icon: '摩', desc: '复活节岛巨像，神秘声望', baseCost: 800, income: 28, maxLevel: 3, w: 110, h: 100, image: 'moai', size: 2, effect: 'moai' },
    /* ===== 现代 / 中式 20 ===== */
    airplane: { name: '飞机', icon: '飞', desc: '停机坪客机，游客纷至沓来', baseCost: 1200, income: 40, maxLevel: 3, w: 130, h: 85, image: 'airplane', size: 2, effect: 'airplane' },
    cannon: { name: '大炮', icon: '炮', desc: '古战炮，防御攻击提升', baseCost: 300, income: 12, maxLevel: 5, w: 96, h: 72, image: 'cannon', size: 1, effect: 'cannon' },
    kfc: { name: 'KFC', icon: '肯', desc: '炸鸡快餐店，收入稳定', baseCost: 450, income: 20, maxLevel: 5, w: 96, h: 72, image: 'kfc', size: 2, effect: 'kfc' },
    mcdonald: { name: '麦当劳', icon: '麦', desc: '汉堡快餐店，收入可观', baseCost: 480, income: 21, maxLevel: 5, w: 96, h: 72, image: 'mcdonald', size: 2, effect: 'mcdonald' },
    mixue: { name: '蜜雪冰城', icon: '蜜', desc: '冰淇淋店，冒险者心情+', baseCost: 420, income: 19, maxLevel: 5, w: 96, h: 72, image: 'mixue', size: 2, effect: 'mixue' },
    school: { name: '学校', icon: '学', desc: '教书育人，冒险者智慧提升', baseCost: 500, income: 22, maxLevel: 5, w: 110, h: 80, image: 'school', size: 2, effect: 'school' },
    kindergarten: { name: '幼儿园', icon: '幼', desc: '天真乐园，全村心情提升', baseCost: 380, income: 17, maxLevel: 5, w: 100, h: 80, image: 'kindergarten', size: 2, effect: 'kindergarten' },
    yangtze_bridge: { name: '长江大桥', icon: '江', desc: '跨江大桥，交通收入大增', baseCost: 2200, income: 65, maxLevel: 3, w: 140, h: 85, image: 'yangtze_bridge', size: 2, effect: 'yangtze_bridge' },
    burj_arab: { name: '帆船酒店', icon: '帆', desc: '七星级帆船酒店，收入超高', baseCost: 3000, income: 80, maxLevel: 3, w: 100, h: 130, image: 'burj_arab', size: 2, effect: 'burj_arab' },
    eiffel: { name: '埃菲尔铁塔', icon: '埃', desc: '巴黎铁塔，地标收入高', baseCost: 1500, income: 50, maxLevel: 3, w: 85, h: 140, image: 'eiffel', size: 2, effect: 'eiffel' },
    sydney_opera: { name: '悉尼歌剧院', icon: '悉', desc: '贝壳歌剧院，演出收入高', baseCost: 1700, income: 54, maxLevel: 3, w: 130, h: 80, image: 'sydney_opera', size: 2, effect: 'sydney_opera' },
    chinese_house_1: { name: '中式建筑·壹', icon: '壹', desc: '四合院，古朴民居', baseCost: 320, income: 14, maxLevel: 5, w: 96, h: 72, image: 'chinese_house_1', size: 2, effect: 'chinese_house_1' },
    chinese_house_2: { name: '中式建筑·贰', icon: '贰', desc: '中式宅院，雅致', baseCost: 340, income: 15, maxLevel: 5, w: 96, h: 72, image: 'chinese_house_2', size: 2, effect: 'chinese_house_2' },
    chinese_house_3: { name: '中式建筑·叁', icon: '叁', desc: '中式楼阁，典雅', baseCost: 360, income: 16, maxLevel: 5, w: 96, h: 84, image: 'chinese_house_3', size: 2, effect: 'chinese_house_3' },
    chinese_house_4: { name: '中式建筑·肆', icon: '肆', desc: '中式园林宅，别致', baseCost: 380, income: 17, maxLevel: 5, w: 96, h: 72, image: 'chinese_house_4', size: 2, effect: 'chinese_house_4' },
    chinese_house_5: { name: '中式建筑·伍', icon: '伍', desc: '中式豪宅，气派', baseCost: 400, income: 18, maxLevel: 5, w: 100, h: 80, image: 'chinese_house_5', size: 2, effect: 'chinese_house_5' },
    snack_busy: { name: '零食很忙', icon: '零', desc: '人气零食店，收入可观', baseCost: 460, income: 21, maxLevel: 5, w: 96, h: 78, image: 'snack_busy', size: 2, effect: 'snack_busy' },
    library: { name: '图书馆', icon: '书', desc: '藏经阁，冒险者经验大增', baseCost: 400, income: 18, maxLevel: 5, w: 96, h: 84, image: 'library', size: 2, effect: 'library' },
  };
